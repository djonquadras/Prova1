...
params:
  ...
  disciplina: "Conversão Eletromecânica de Energia A - Turma 06213"
...
\pagestyle{plain}
```{r echo=FALSE, child="questao1.Rmd"}
```
...
\newpage
\pagestyle{plain}
```{r echo=FALSE, child="questao2.Rmd"}
```
...
\newpage
\pagestyle{plain}
```{r echo=FALSE, child="questao3.Rmd"}
```
